...
# Экстрафича
Я добавил историю тренировок.

**Чем это полезно для пользователя:** просматривать историю своих тренировок, отслеживать свой прогресс.

**Чем это полезно для меня:** попробовать свои силы в создании более сложных компонентов и страниц.
